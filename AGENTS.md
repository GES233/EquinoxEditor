...
- `engine_adapters/` — `:equinox_engine_adapters` (userland engine adapter reference implementations `EquinoxAdapters.*`; path-depends on domain + kernel, nothing depends on it)
